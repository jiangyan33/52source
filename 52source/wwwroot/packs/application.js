...
/***/ (function(module, exports) {
    ...
    /* harmony import */ var _feizheng_next_js_core2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @feizheng/next-js-core2 */ "./node_modules/@feizheng/next-js-core2/dist/next-js-core2.js");
    /* harmony import */ var _feizheng_next_js_core2__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_feizheng_next_js_core2__WEBPACK_IMPORTED_MODULE_0__);
    /* harmony import */ var _feizheng_next_to_clipboard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @feizheng/next-to-clipboard */ "./node_modules/@feizheng/next-to-clipboard/dist/next-to-clipboard.js");
    /* harmony import */ var _feizheng_next_to_clipboard__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_feizheng_next_to_clipboard__WEBPACK_IMPORTED_MODULE_1__);
      ...
      _createClass(App, [{
        ...
        value: function detail() {
          $(document).ready(function () {
            ...
            $('.docify-catalogue .is-action').on('click', function () {
        ...
        value: function index() {
          $(document).ready(function () {
            // lazyload images:
            $('.post-item img').lazyload(); // https://www.cssscript.com/demo/tilted-navigation-clip-path/
        ...
        value: function collect() {
          var el = $('.docify-collect');
          if (!el.length) return;
          el.find('a').click(function () {
            var collected = el.attr('data-collected');
            var target = collected !== 'true';
        ...
        value: function animateSlide() {
          if (!$.throttle) return;
          $(document).ready(function () {
            var subtitle = $('.docify-global-search h3');
            $(window).scroll($.throttle(500, true, function () {
              var top = $(window).scrollTop();
              var visible = subtitle.is(':visible');
    ...
    /***/ "./node_modules/@feizheng/next-js-core2/dist/next-js-core2.js":
    /*!********************************************************************!*\
      !*** ./node_modules/@feizheng/next-js-core2/dist/next-js-core2.js ***!
      \********************************************************************/
    /*! no static exports found */
    ...
    (function () {
      ...
      var freeModule = freeExports && ( false ? undefined : _typeof(module)) == 'object' && module && !module.nodeType && module; //force inject to global:
      ...
      if ( true && _typeof(__webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js")) == 'object' && __webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js")) {
        root.nx = nx; // Define as an anonymous module so, through path mapping, it can be
        ...
        !(__WEBPACK_AMD_DEFINE_RESULT__ = (function () {
          ...
          // Export for Node.js.
          (freeModule.exports = nx).nx = nx; // Export for CommonJS support.
      ...
      (function () {
        ...
        nx.each = function (inTarget, inCallback, inContext) {
          ...
          var iterator = function iterator(inKey, inValue, inIsArray) {
            return inCallback.call(inContext, inKey, inValue, inTarget, inIsArray) === nx.BREAKER;
          };
    
          if (inTarget) {
            length = inTarget.length;
    
            if (_typeof(length) === NUMBER) {
        ...
        nx.get = function (inTarget, inPath, inValue) {
          ...
          return _typeof(inValue) !== UNDEF && result == null ? inValue : result;
        };
    
        nx.path = function (inTarget, inPath, inValue) {
          return inValue == null ? this.get(inTarget, inPath) : this.set(inTarget, inPath, inValue);
        };
      })();
      ...
      (function () {
        ...
        nx.defineProperty = function (inTarget, inName, inMeta, inIsStatic) {
          ...
          var value, filed;
          var typeOfObject = _typeof(inMeta) === 'object';
          var meta = inMeta && typeOfObject ? inMeta : {
            value: inMeta
          };
          ...
          if (VALUE in meta) {
            ...
            setter = function setter(inValue) {
              this[filed] = inValue;
            };
          } else {
        ...
        nx.defineBombMethod = function (inTarget, inName, inMeta, inIsStatic) {
          ...
          keys.forEach(function (key, index) {
            nx.defineMethod(inTarget, key, inMeta.call(inTarget, key, index), inIsStatic);
          });
        };
      ...
      (function () {
        ...
        LifeCycle.prototype = {
          ...
          initMetaProcessor: function initMetaProcessor() {
            var meta = this.meta;
          ...
          createClassProcessor: function createClassProcessor() {
            var self = this;
          ...
          inheritProcessor: function inheritProcessor() {
          ...
          inheritedClass: function inheritedClass(inClassMeta) {
          ...
          defineMethods: function defineMethods(inClassMeta, inIsStatic) {
          ...
          defineProperties: function defineProperties(inClassMeta) {
            var isStatic = inClassMeta.__static__;
            var target = isStatic ? this.__class__ : this.__class__.prototype;
            target.__properties__ = nx.mix(inClassMeta.__properties__, this.meta.properties);
            nx.defineMembers('Property', target, target.__properties__, isStatic);
          },
          methodsConstructorProcessor: function methodsConstructorProcessor() {
            var classMeta = this.__class_meta__;
          ...
          staticsConstructorProcessor: function staticsConstructorProcessor() {
            var classMeta = this.__class_meta__;
    
            classMeta.__static_init__.call(this.__class__);
          },
          registerProcessor: function registerProcessor() {
            var Class = this.__class__;
            var type = this.type;
            var classMeta = this.__class_meta__;
          ...
          registerDebug: function registerDebug(inInstance) {
            if (nx.DEBUG) {
    ...
    /***/ "./node_modules/@feizheng/next-to-clipboard/dist/next-to-clipboard.js":
    /*!****************************************************************************!*\
      !*** ./node_modules/@feizheng/next-to-clipboard/dist/next-to-clipboard.js ***!
      \****************************************************************************/
    /*! no static exports found */
    ...
    (function () {
      ...
      var nx = global.nx || __webpack_require__(/*! @feizheng/next-js-core2 */ "./node_modules/@feizheng/next-js-core2/dist/next-js-core2.js");
    ...
    /******/ });
    //# sourceMappingURL=application-59bbbba1ef6c13c82572.js.map